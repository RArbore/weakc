...
pub fn map_num_and_type_to_reg(num: i32, ty: X86VirtualRegisterType) -> X86PhysicalRegisterID {
    match (num, ty) {
        ...
        (1, X86VirtualRegisterType::Fixed32) => X86PhysicalRegisterID::EBX,
        (2, X86VirtualRegisterType::Fixed32) => X86PhysicalRegisterID::ECX,
        (3, X86VirtualRegisterType::Fixed32) => X86PhysicalRegisterID::EDX,
        (4, X86VirtualRegisterType::Fixed32) => X86PhysicalRegisterID::ESI,
        (5, X86VirtualRegisterType::Fixed32) => X86PhysicalRegisterID::EDI,
        (6, X86VirtualRegisterType::Fixed32) => X86PhysicalRegisterID::ESP,
        (7, X86VirtualRegisterType::Fixed32) => X86PhysicalRegisterID::EBP,
        (8, X86VirtualRegisterType::Fixed32) => X86PhysicalRegisterID::R8D,
        (9, X86VirtualRegisterType::Fixed32) => X86PhysicalRegisterID::R9D,
        (10, X86VirtualRegisterType::Fixed32) => X86PhysicalRegisterID::R10D,
        (11, X86VirtualRegisterType::Fixed32) => X86PhysicalRegisterID::R11D,
        (12, X86VirtualRegisterType::Fixed32) => X86PhysicalRegisterID::R12D,
        (13, X86VirtualRegisterType::Fixed32) => X86PhysicalRegisterID::R13D,
        (14, X86VirtualRegisterType::Fixed32) => X86PhysicalRegisterID::R14D,
        (15, X86VirtualRegisterType::Fixed32) => X86PhysicalRegisterID::R15D,
        (0, X86VirtualRegisterType::Fixed64) => X86PhysicalRegisterID::RAX,
        (1, X86VirtualRegisterType::Fixed64) => X86PhysicalRegisterID::RBX,
        (2, X86VirtualRegisterType::Fixed64) => X86PhysicalRegisterID::RCX,
        (3, X86VirtualRegisterType::Fixed64) => X86PhysicalRegisterID::RDX,
        (4, X86VirtualRegisterType::Fixed64) => X86PhysicalRegisterID::RSI,
        (5, X86VirtualRegisterType::Fixed64) => X86PhysicalRegisterID::RDI,
        (6, X86VirtualRegisterType::Fixed64) => X86PhysicalRegisterID::RSP,
        (7, X86VirtualRegisterType::Fixed64) => X86PhysicalRegisterID::RBP,
        (8, X86VirtualRegisterType::Fixed64) => X86PhysicalRegisterID::R8,
        (9, X86VirtualRegisterType::Fixed64) => X86PhysicalRegisterID::R9,
        (10, X86VirtualRegisterType::Fixed64) => X86PhysicalRegisterID::R10,
        (11, X86VirtualRegisterType::Fixed64) => X86PhysicalRegisterID::R11,
        (12, X86VirtualRegisterType::Fixed64) => X86PhysicalRegisterID::R12,
        (13, X86VirtualRegisterType::Fixed64) => X86PhysicalRegisterID::R13,
        (14, X86VirtualRegisterType::Fixed64) => X86PhysicalRegisterID::R14,
        (15, X86VirtualRegisterType::Fixed64) => X86PhysicalRegisterID::R15,
        (0, X86VirtualRegisterType::Float64) => X86PhysicalRegisterID::XMM0,
        (1, X86VirtualRegisterType::Float64) => X86PhysicalRegisterID::XMM1,
        (2, X86VirtualRegisterType::Float64) => X86PhysicalRegisterID::XMM2,
        (3, X86VirtualRegisterType::Float64) => X86PhysicalRegisterID::XMM3,
        (4, X86VirtualRegisterType::Float64) => X86PhysicalRegisterID::XMM4,
        (5, X86VirtualRegisterType::Float64) => X86PhysicalRegisterID::XMM5,
        (6, X86VirtualRegisterType::Float64) => X86PhysicalRegisterID::XMM6,
        (7, X86VirtualRegisterType::Float64) => X86PhysicalRegisterID::XMM7,
        (8, X86VirtualRegisterType::Float64) => X86PhysicalRegisterID::XMM8,
        (9, X86VirtualRegisterType::Float64) => X86PhysicalRegisterID::XMM9,
        (10, X86VirtualRegisterType::Float64) => X86PhysicalRegisterID::XMM10,
        (11, X86VirtualRegisterType::Float64) => X86PhysicalRegisterID::XMM11,
        (12, X86VirtualRegisterType::Float64) => X86PhysicalRegisterID::XMM12,
        (13, X86VirtualRegisterType::Float64) => X86PhysicalRegisterID::XMM13,
        (14, X86VirtualRegisterType::Float64) => X86PhysicalRegisterID::XMM14,
        (15, X86VirtualRegisterType::Float64) => X86PhysicalRegisterID::XMM15,
        _ => panic!("PANIC: Invalid num to map to physical register."),
    }
}
...
pub const X86_NUM_ALLOC_PHYSICAL_REGISTERS: usize = 32;
...
impl X86PhysicalRegisterID {
    ...
    pub fn get_pack_and_pos(&self) -> (i32, i32) {
        match self {
